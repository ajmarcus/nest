...
create table if not exists dw.tmp_fact_yelp
    ...
    review_count INT comment 'Number of reviews of the business',
...
create table if not exists dw.fact_review_denorm 
    ...
    review_votes_useful INT comment 'count of useful votes',
    review_votes_funny INT comment 'count of funny votes',
    review_votes_cool INT comment 'count of cool votes',
    user_name STRING comment 'first name and last initial of user',
    user_review_count INT comment 'review count',
    user_average_stars INT comment 'average stars multiplied by 10,000',
    user_votes_useful INT comment 'count of useful votes across all reviews',
    user_votes_funny INT comment 'count of funny votes across all reviews',
    user_votes_cool INT comment 'count of cool votes across all reviews',
    ...
    business_review_count INT comment 'review count',
